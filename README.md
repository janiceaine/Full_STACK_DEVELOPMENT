...
Travlr is a full-stack web application designed to provide a seamless travel experience for both customers and administrators. The application allows users to browse and book trips while providing an administrative panel for managing bookings and travel data. The final iteration of the project incorporated security features, including authentication for admin users, to ensure secure access and data protection.
